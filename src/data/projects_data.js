...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      '금융 거래 데이터를 분석하여 신용카드 사기 거래를 탐지하는 시스템입니다. 데이터 전처리, 특징 추출, 머신러닝 모델링을 포함합니다.',
    tags: [
      'React',
      'FastAPI',
      'Python',
  ...
  {
    type: 'Personal',
    name: '개인 야구 기록지 웹 어플리케이션',
    context: '개인 프로젝트',
    period: '2025.11.16 - 2025.11.17',
    description:
      'Vue와 Vite를 사용하여 개발한 개인 야구 기록지 웹 애플리케이션입니다. 사용자는 경기 데이터를 입력하고 관리할 수 있습니다.',
    tags: ['Vue.js', 'Vite', 'Bootstrap', 'JavaScript'],
